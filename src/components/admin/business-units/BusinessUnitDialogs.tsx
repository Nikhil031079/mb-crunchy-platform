...
export function BusinessUnitDialogs({ deleteTarget, restoreTarget, onDeleteOpenChange, onRestoreOpenChange, onConfirmDelete }: BusinessUnitDialogsProps) {
  return <>
